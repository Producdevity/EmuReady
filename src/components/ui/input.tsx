...
export const Input = React.forwardRef<HTMLElement, InputProps>(
  ({ leftIcon, rightIcon, className = '', as = 'input', children, ...props }, ref) => {
    ...
    return (
      <div className={`relative flex items-center bg-white/80 dark:bg-gray-800/80 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 focus-within:ring-2 focus-within:ring-blue-500 transition-all duration-200 ${className}`}>
        {leftIcon && (
