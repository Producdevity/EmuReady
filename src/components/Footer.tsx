    ...
    <footer className="bg-gradient-to-t from-gray-900 via-gray-800 to-gray-900 border-t border-gray-800 py-12 mt-16 text-gray-300">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-4">About</h3>
          ...
          <div>
            <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-4">Community</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/contribute" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Contribute
                </Link>
              </li>
              <li>
                <Link href="/forum" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Forum
                </Link>
              </li>
            </ul>
