            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-gray-600 dark:text-gray-300">
                  These contributors fuel EmuReady with up-to-date compatibility reports and
                  approved game data. Visit their profiles to explore their work, upvote helpful
                  listings, or leave informed feedback.
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {contributors.map((contributor) => {
                    const lastContributionLabel = contributor.contributions.lastContributionAt
                      ? formatDistanceToNow(contributor.contributions.lastContributionAt, {
                          addSuffix: true,
                        })
                      : 'No recent activity'
