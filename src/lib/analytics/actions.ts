...
export const FILTER_ACTIONS = {
  ...
  CLEAR_CPU_FILTER: 'clear_cpu_filter',
  CLEAR_GPU_FILTER: 'clear_gpu_filter',
...
export const ENGAGEMENT_ACTIONS = {
  ...
  SUPPORT_BANNER_SHOWN: 'support_banner_shown',
  SUPPORT_BANNER_DISMISSED: 'support_banner_dismissed',
  SUPPORT_BANNER_CTA: 'support_banner_cta',
