...
export const CreatePermissionSchema = z.object({
  key: z
    ...
    .min(1)
    .max(100)
    .regex(/^[a-z_]+$/, 'Key must only contain lowercase letters and underscores'),
...
export const PermissionLogSortField = z.enum(['createdAt', 'action', 'userId', 'targetRole'])
...
export type BulkUpdateRolePermissionsInput = z.infer<typeof BulkUpdateRolePermissionsSchema>
...
export type BulkPermissionActionInput = z.infer<typeof BulkPermissionActionSchema>
...
export type GetPermissionLogByIdInput = z.infer<typeof GetPermissionLogByIdSchema>
export type GetPermissionTimelineInput = z.infer<typeof GetPermissionTimelineSchema>
export type GetUserPermissionActivityInput = z.infer<typeof GetUserPermissionActivitySchema>
export type ExportPermissionLogsInput = z.infer<typeof ExportPermissionLogsSchema>
