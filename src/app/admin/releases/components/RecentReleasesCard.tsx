            ...
            listQuery.data.map((r) => (
              ...
              >
                <div className="text-sm">
                  ...
                  <div className="text-xs text-gray-500 break-all">sha256: {r.fileSha256}</div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-xs text-gray-500 min-w-[72px] text-right">
                    {bytesToHuman(Number(r.sizeBytes))}
                  </span>
                  <Button
                    variant="outline"
                    size="sm"
