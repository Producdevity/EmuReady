...
export const EmulatorCompatibilitySchema = z.object({
  ...
  emulatorLogo: z.string().nullable().describe('Emulator logo filename'),
...
export const DeviceCompatibilityResponseSchema = z.object({
  device: z.object({
    ...
    socId: z.string().uuid().nullable().describe('System-on-Chip UUID'),
    socName: z.string().nullable().describe('System-on-Chip name'),
    socManufacturer: z.string().nullable().describe('System-on-Chip manufacturer'),
  }),
