...
import { Button, ColumnVisibilityControl, AdminTableContainer, SortableHeader, Pagination } from '@/components/ui'
...
type ApprovalSortField = 'game.title' | 'game.system.name' | 'device' | 'emulator.name' | 'createdAt' | 'author.name'
