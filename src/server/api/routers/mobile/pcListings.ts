...
export const mobilePcListingsRouter = createMobileTRPCRouter({
   ...
   * @deprecated PC Presets have been moved to mobile.preferences.pcPresets
   */
  presets: createMobileTRPCRouter({
    /**
     * @deprecated Use mobile.preferences.pcPresets.get instead
     */
    get: mobileProtectedProcedure
      .input(GetPcPresetsSchema)
      .query(async ({ ctx, input }) => {
        console.warn(
          'mobile.pcListings.presets.get is deprecated. Use mobile.preferences.pcPresets.get instead.',
        )
    ...
    /**
     * @deprecated Use mobile.preferences.pcPresets.create instead
     */
    create: mobileProtectedProcedure
      .input(CreatePcPresetSchema)
      .mutation(async ({ ctx, input }) => {
        console.warn(
          'mobile.pcListings.presets.create is deprecated. Use mobile.preferences.pcPresets.create instead.',
        )
    ...
    /**
     * @deprecated Use mobile.preferences.pcPresets.update instead
     */
    update: mobileProtectedProcedure
      .input(UpdatePcPresetSchema)
      .mutation(async ({ ctx, input }) => {
        console.warn(
          'mobile.pcListings.presets.update is deprecated. Use mobile.preferences.pcPresets.update instead.',
        )
    ...
    /**
     * @deprecated Use mobile.preferences.pcPresets.delete instead
     */
    delete: mobileProtectedProcedure
      .input(DeletePcPresetSchema)
      .mutation(async ({ ctx, input }) => {
        console.warn(
          'mobile.pcListings.presets.delete is deprecated. Use mobile.preferences.pcPresets.delete instead.',
        )
        // Check if user owns the preset
        const existing = await ctx.prisma.userPcPreset.findUnique({
          where: { id: input.id },
