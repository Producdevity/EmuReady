...
import { type DeveloperApiKeyRow, type DeveloperPagination } from './types'
...
interface Props {
  ...
  keys: DeveloperApiKeyRow[]
  selectedKeyId: string | null
  includeRevoked: boolean
  isLoading: boolean
  pagination: DeveloperPagination | undefined
  hasQuery: boolean
  onSelectKey: (keyId: string) => void
  onRotateKey: (keyId: string) => Promise<void> | void
  onRevokeKey: (keyId: string) => Promise<void> | void
}

export function DeveloperKeyTable(props: Props) {
        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
            {props.keys.map((key) => {
              ...
              const isSelected = props.selectedKeyId === key.id
              return (
                <tr
                  key={key.id}
                  className={cn(
