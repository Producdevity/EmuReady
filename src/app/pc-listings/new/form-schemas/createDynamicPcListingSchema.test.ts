...
import createDynamicPcListingSchema from './createDynamicPcListingSchema'

describe('createDynamicPcListingSchema - Custom Field Validation', () => {
  const baseValidData = {
    gameId: '123e4567-e89b-12d3-a456-426614174000',
    emulatorId: '123e4567-e89b-12d3-a456-426614174001',
    cpuId: '123e4567-e89b-12d3-a456-426614174002',
    performanceId: 1,
    memorySize: 16,
    os: PcOs.WINDOWS,
    osVersion: '11',
  ...
  describe('BOOLEAN field validation', () => {
    it('should accept true for required boolean field', () => {
      ...
      const schema = createDynamicPcListingSchema(customFields)
